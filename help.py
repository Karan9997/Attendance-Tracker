...
class Help:
    def __init__(self,root):
        ...
        #background image
        img=Image.open(r"C:\Users\golis\OneDrive\Desktop\face recognition\photos\bb.jpg")
        ...
        title_lbl=Label(self.root,text="       Queries?",font=("Calibri Light",15,"bold"),fg="black")
